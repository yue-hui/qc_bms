<template>
  <div class="work-orders-acceptance">
          ...
          <el-table-column
            ...
            <template slot-scope="scope">
              <p
                ...
                @click="accept_work_order(scope.row)">{{ scope.row.ticket_title }}</p>
            </template>
          </el-table-column>
          <el-table-column
            align="center"
...
export default {
  ...
  methods: {
    ...
    refresh() {
      this.this.page = 1
      this.fetch_acceptance_work_orders()
    },
    search() {
      this.fetch_acceptance_work_orders()
    },
    fetch_acceptance_work_orders() {
      this.loading = true
